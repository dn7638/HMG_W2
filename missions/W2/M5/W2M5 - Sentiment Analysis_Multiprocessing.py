...
#### unit test
## print(preprocess(["asd kfa sf dkl", "sjdf sdf fs afd das asd f"]))
# positive_tweets = ["a b c d e f g h i j k l m n o p", "a1 b1 c1 d1 e1 f1 g1 h1 i1 j1 k1 l1 m1 n1 o1 p1", "a b c d e f g h i j k l m n o p", "a2 b2 c2 d2 e 2f 2g 2h 2i 2j 2k 2l 2m 2n 2o 2p", "3a b3 c3 d3 e3 f3 g3 h3 3i 3j 3k 3l 3m 3n 3o 3p"]
if __name__ == "__main__":
    ...
    # 긍정 및 부정 트윗 전처리
    positive_tokens = list(return_pos_list)
    negative_tokens = list(return_neg_list)
